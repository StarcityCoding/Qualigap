    ...
    <div className="group">
      <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg xl:aspect-w-7 xl:aspect-h-8">
        <Image
          ...
          objectFit=""
          className=
            'duration-700 object-cover relative object-center rounded-xl ease-in-out group-hover:opacity-75 scale-100 blur-0 grayscale-0'
    ...
    <div className="group">
      <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg xl:aspect-w-7 xl:aspect-h-8">
        <Image
          ...
          objectFit=""
          className=
            'duration-700 object-cover object-center rounded-xl ease-in-out group-hover:opacity-75 scale-100 blur-0 grayscale-0'
