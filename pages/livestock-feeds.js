...
export default function Livestock(){
    ...
    useEffect(() => {
      ...
      return(
        <>
          <Head>
        <title>Livestock Products | Qualigap.com</title>
      </Head>
      <NextSeo
            title='Seedling Products | Qualigap.com'
            canonical='https://qualigap.com/livestock-products'
            openGraph={{
           
              url: 'https://qualigap.com/livestock-products',
          }}
        />
...
<div className=" pl-6 pr-8 pb-6 relative flex lg:justify-center lg:text-center">
    ...
    content-center">Livestock Products</h1>
