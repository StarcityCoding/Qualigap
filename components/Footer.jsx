...
<div className="lg:ml-5 py-5">
    ...
    <div className="md:text-[20px]"> 
           ...
           <div className="relative -top-7 pl-[30px] lg:pr-20"> Alhaji Lati Warehouse, 
           Beside Id Praying Ground, Adjacent First Bank, Bida, Niger State.</div>
</div>
...
<div className="text-[#f1cf69] -ml-1">
            ...
            <div className="font-medium"> 
           <div className="relative -top-7 pl-[30px]"> +234 815 330 4104<br/>
+234 802 697 0214</div>
</div>
...
<div className="text-[#f1cf69] -ml-1">
            ...
            <div className="font-medium"> 
           <div className="relative -top-6 pl-[30px]">  info@qualigap.com<br/>
           qualigap@gmail.com</div>
</div>
...
<div className="mt-5 md:mx-0 lg:mx-0 text-[#b3c5b5] text-left rounded-[15px] shadow-sm shaddow-[#b3c5b5]">
  ...
  <div className="lg:ml-5 lg:py-5">
      ...
      {/*  */}
        ...
        <div className="bg-[#6d8c54] flex flex-col lg:flex lg:flex-row text-white/70 pt-10 pb-5 lg:pb-10">
            ...
            <div className="lg:basis-2/4 lg:pr-10 lg:pl-20 px-16 md:px-28 py-5 lg:-mt-3 lg:py-0 justify-center content-center text-center  lg:justify-right lg:content-right lg:text-right">
            ...
            <div className='flex items-center justify-between w-full'>
                ...
                <Link href='/#contact'>
                  <div
                    onClick={() => setNav(!nav)}
                    className='rounded-full shadow-lg text-[#f1cf69] bg-[#263c28] p-3 cursor-pointer hover:scale-105 ease-in duration-300'
                  >
                    <AiOutlineMail />
                  </div>
                </Link>
