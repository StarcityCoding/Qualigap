          ...
          >
            ...
            <div className='flex items-center justify-between w-full sm:w-[80%]'>
                <a
                  ...
                  rel='noreferrer'
                >
                  <div className='rounded-full shadow-lg bg-[#6d8c54] p-3 cursor-pointer hover:scale-105 ease-in duration-300'>
                    <FaFacebook />
                  </div>
                </a>
                <a
                ...
                <Link href='/#contact'>
                  <div
                    onClick={() => setNav(!nav)}
                    className='rounded-full shadow-lg bg-[#6d8c54] p-3 cursor-pointer hover:scale-105 ease-in duration-300'
                  >
                    <AiOutlineMail />
                  </div>
                </Link>
