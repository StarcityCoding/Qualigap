...
<div id="servo">
    ...
    <h1 className="text-[#b3c5b5] font-[400] text-lg">
                ...
                <div className="py-5 border-b-[#FFFFFF33] border-b-[2px]">
          ...
          >
            ...
            <BiUserVoice size={80} />
                ...
                The consultancy services range from trainings to farmer support on all aspects of crop production; agronomically and technically.
          ...
          >
             <div className="bg-[#263c28] p-5 rounded-full md:absolute">
            <GiFarmTractor size={80} />
            </div>
            
                </div>
                </button>
                <div className="md:relative md:pl-[140px] -top-1">
                <h1 className="font-bold text-2xl py-3">
                    Extension Service
                </h1>
                
                <p className="text-[#dbe6d2] font-[400] text-[18px] leading-9 pb-2">
                Our network of agronomists and specialist advisors enable us to provide tailored and practical solutions countrywide.
                </p>
                </div>
                </div>
            ...
            <GiFarmer size={80} />
                ...
                <div className="md:relative md:pl-[140px] -top-1">
                <h1 className="font-bold text-2xl py-3">
                    Dealership, Supplier & Retail
                </h1>
                
                <p className="text-[#dbe6d2] font-light text-[18px] leading-9 pb-5">
               We are dealers on all kinds of agro inputs, we sell and market agro products ranging from fertlizers, seedlings, agrochemicals and various agro inputs to individuals and organizations.                 </p>
                </div>
                </div>
...
<p className="leading-9 mt-8 font-light px-2 md:px-0 text-[18px] text-[#dbe6d2]">
                    We envision becoming the leading Agro-Inputs Supplier in Africa by serving all farmers in the agricultural sector around the world. We are dedicated to serving farmers on all scales by providing original, reliable and latest premium quality Agro inputs. We believe in delivering optimum quality food for a better world through outstanding crop solutions and take pride in meeting our commitments to our stakeholders. 
                     </p>
